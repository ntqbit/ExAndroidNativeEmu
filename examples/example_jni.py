...
g_cfd = GroupLogger([StdOutLogger(), FileLogger(open('./ins-jni.txt', 'a'))])
# Add debugging.
...
class MainActivity(
        ...
        jvm_name='local/myapp/testnativeapp/MainActivity'):

    def __init__(self):
        pass

    @java_method_def(name='stringFromJNI',
...
try:
    ...
    logger.info("Response from JNI call: %s" %
