...
class Buffer(metaclass=JavaClassDef, jvm_name='okio/Buffer'):
    ...
    @java_method_def(name='writeString',
                     args_list=["jstring",
                                "jobject"],
...
class HttpUrl(metaclass=JavaClassDef, jvm_name='okhttp3/HttpUrl'):
    ...
    @java_method_def(name='encodedPath',
                     signature='()Ljava/lang/String;',
                     native=False)
    def encodedPath(self, emu):
        raise NotImplementedError()

    @java_method_def(name='encodedQuery',
                     signature='()Ljava/lang/String;',
                     native=False)
...
class Response(metaclass=JavaClassDef, jvm_name='okhttp3/Response'):
    ...
    @java_method_def(name='body',
                     signature='()Lokhttp3/ResponseBody;',
                     native=False)
    def body(self, emu):
        raise NotImplementedError()
