...
class WifiInfo(metaclass=JavaClassDef, jvm_name='android/net/wifi/WifiInfo'):
    ...
    @java_method_def(name='getMacAddress',
...
class WifiManager(
    ...
    @java_method_def(name='getSubscriberId',
                     signature='()Ljava/lang/String;',
                     native=False)
    ...
    @java_method_def(name='getConnectionInfo',
    ...
    @java_method_def(name='getActiveNetworkInfo',
                     signature='()Landroid/net/NetworkInfo;', native=False)
    def getActiveNetworkInfo(self, *args, **kwargs):
        # TODO read from config
        return NetworkInfo()


class TelephonyManager(metaclass=JavaClassDef,
                       jvm_name='android/telephony/TelephonyManager'):
    def __init__(self):
        pass
...
class RequestBuilder(
        metaclass=JavaClassDef,
        jvm_name='android/net/NetworkRequest$Builder'):
    def __init__(self):
        pass
    ...
    @java_method_def(name='addTransportType',
...
class ConnectivityManager(metaclass=JavaClassDef,
