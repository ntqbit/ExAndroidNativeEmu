...
class AccessibilityManager(
    ...
    @java_method_def(name='getEnabledAccessibilityServiceList',
                     args_list=["jint"],
...
class IActivityManager(metaclass=JavaClassDef,
                       jvm_name='android/app/IActivityManager'):
...
class ActivityManagerNative(metaclass=JavaClassDef,
                            jvm_name='android/app/ActivityManagerNative'):

    def __init__(self):
        pass

    @staticmethod
    @java_method_def(name='getDefault',
...
class Instrumentation(metaclass=JavaClassDef,
                      jvm_name='android/app/Instrumentation'):
...
class ActivityThread(metaclass=JavaClassDef, jvm_name='android/app/ActivityThread',
                     jvm_fields=[
                         JavaFieldDef(
                             'mActivities', 'Landroid/util/ArrayMap;', False),
    ...
    @staticmethod
    @java_method_def(name='currentActivityThread',
    ...
    @staticmethod
    @java_method_def(name='currentApplication',
    ...
    @java_method_def(name='getSystemContext',
